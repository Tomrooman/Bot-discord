                ...
                res.data.map(setting => {
                    settings[setting.guildId] = {
                        ...
                        twitter: {
                            ...
                            warzone: {
                                status: setting.twitter && setting.twitter.warzone ? setting.twitter.warzone.status : 'off',
                                channelID: setting.twitter && setting.twitter.warzone ? setting.twitter.warzone.channelID : '123',
                                channelName: setting.twitter && setting.twitter.warzone ? setting.twitter.warzone.channelName : '123'
                            }
                        }
                    };
                });
